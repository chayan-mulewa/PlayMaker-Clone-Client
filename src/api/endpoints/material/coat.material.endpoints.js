// src/api/endpoints/material/coat.material.endpoints.js
import { coatMaterialApiSlice } from "../../slices";

export const coatMaterialApi = coatMaterialApiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getCoatMaterials: builder.query({
    ...
    updateCoatMaterial: builder.mutation({
      query: ({ id, data }) => ({
        url: `/${id}`,
        method: "PUT",
        credentials: "include",
      ...
      onQueryStarted: async (
        ...
        const patchResult = dispatch(
          coatMaterialApi.util.updateQueryData(
            "getCoatMaterials",
            { skip, limit: 6 },
            (draft) => {
    ...
    deleteCoatMaterial: builder.mutation({
      query: ({ id }) => ({
        url: `/${id}`,
        method: "DELETE",
        credentials: "include",
    ...
    createCoatMaterial: builder.mutation({
      query: ({ data }) => {
