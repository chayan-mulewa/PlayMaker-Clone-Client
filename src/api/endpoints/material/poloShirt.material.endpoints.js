// src/api/endpoints/material/poloShirt.material.endpoints.js
import { poloShirtMaterialApiSlice } from "../../slices";

export const poloShirtMaterialApi = poloShirtMaterialApiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getPoloShirtMaterials: builder.query({
    ...
    updatePoloShirtMaterial: builder.mutation({
      query: ({ id, data }) => ({
        url: `/${id}`,
        method: "PUT",
        credentials: "include",
      ...
      onQueryStarted: async (
        ...
        const patchResult = dispatch(
          poloShirtMaterialApi.util.updateQueryData(
            "getPoloShirtMaterials",
            { skip, limit: 6 },
            (draft) => {
    ...
    deletePoloShirtMaterial: builder.mutation({
      query: ({ id }) => ({
        url: `/${id}`,
        method: "DELETE",
        credentials: "include",
    ...
    createPoloShirtMaterial: builder.mutation({
      query: ({ data }) => {
