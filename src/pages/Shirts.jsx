...
import { shirtMaterialApi, cartApi } from "../api/endpoints";
...
export default function Shirts() {
  ...
  const { data, isLoading } = shirtMaterialApi.useGetShirtMaterialsQuery({
    skip,
    limit,
  });
  ...
  const measurementType = useMemo(
    () => [
      ...
      },
      {
        ...
        name: "shirtLength",
        rules: [{ required: true, message: "Shirt length is required" }],
        min: 60,
        max: 120,
        initialValue: 75,
      },
...

      {
        label: "Wrist (cm)",
        name: "wrist",
        rules: [{ required: true, message: "Wrist is required" }],
        min: 10,
        max: 30,
        initialValue: 20,
      },
      ...
      {
        label: "Pocket Width (cm)",
        name: "pocketWidth",
        rules: [{ required: true, message: "Pocket Width is required" }],
        min: 5,
        max: 10,
        initialValue: 8,
      },
      {
        label: "Pocket Height (cm)",
        name: "pocketHeight",
        rules: [{ required: true, message: "Pocket Height is required" }],
        min: 5,
        max: 10,
        initialValue: 8,
      },
  ...
  const handleMeasurementSubmit = (values) => {
    ...
    messageApi.open({
      type: "success",
      content: "Measurements for shirt created",
    });
  };
  ...
  const handleAddToCart = async () => {
    const data = {
      selectedMaterial: { type: "ShirtMaterial", ...selectedMaterial },
      selectedDesign: { type: "ShirtDesign", ...selectedDesigns },
      selectedMeasurement: {
