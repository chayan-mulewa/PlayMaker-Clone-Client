...
import { pantMaterialApi, cartApi } from "../api/endpoints";
...
export default function Pants() {
  ...
  const handleMeasurementSubmit = (values) => {
    ...
    messageApi.open({
      type: "success",
      content: "Measurements For Pant Is Created",
    });
  };
  ...
  const handleAddToCart = async () => {
    const data = {
      selectedMaterial: { type: "PantMaterial", ...selectedMaterial },
      selectedDesign: { type: "PantDesign", ...selectedDesigns },
      selectedMeasurement: {
        type: "PantMeasurement",
