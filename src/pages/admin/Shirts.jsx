...
import { shirtMaterialApi } from "../../api/endpoints";
...
export default function Shirts() {
  ...
  const [createShirtMaterial] =
    shirtMaterialApi.useCreateShirtMaterialMutation();
  const [updateShirtMaterial] =
    shirtMaterialApi.useUpdateShirtMaterialMutation();
  const [deleteShirtMaterial] =
    shirtMaterialApi.useDeleteShirtMaterialMutation();
  ...
  const handleCreateMaterial = async (values) => {
    ...
    try {
      const res = await createShirtMaterial({
        data: newMaterial,
        skip,
      }).unwrap();
  ...
  const handleUpdateMaterial = async (values) => {
    ...
    try {
      const res = await updateShirtMaterial({
  ...
  const handleDeleteMaterial = async (id) => {
    try {
      const res = await deleteShirtMaterial({ id, skip }).unwrap();
      messageApi.success(res.message);
    } catch (error) {
