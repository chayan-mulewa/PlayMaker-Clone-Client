...
import { jeansMaterialApi, cartApi } from "../api/endpoints";
...
export default function Jeans() {
  ...
  const handleMeasurementSubmit = (values) => {
    ...
    messageApi.open({
      type: "success",
      content: "Measurements For Jeans Is Created",
    });
  };
  ...
  const handleAddToCart = async () => {
    const data = {
      selectedMaterial: { type: "JeansMaterial", ...selectedMaterial },
      selectedDesign: { type: "JeansDesign", ...selectedDesigns },
      selectedMeasurement: {
        type: "JeansMeasurement",
